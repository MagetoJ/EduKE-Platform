...
<body>
    <div class="container">
        <div class="header">
            <h1>🎉 Welcome to EduKE!</h1>
            <p>Your school is ready to go</p>
        </div>
        <div class="content">
            <p>Hello <strong>{full_name}</strong>,</p>

            <p>Congratulations! Your school <strong>{business_name}</strong> has been successfully registered on EduKE.</p>

            <div class="info-box">
                <h3>Your School Details:</h3>
                <p><strong>School Name:</strong> {business_name}</p>
                <p><strong>Subdomain:</strong> <span class="subdomain">{subdomain}.eduke.com</span></p>
            ...
            <ul class="checklist">
                <li><strong>Set up your school profile</strong> - Add your logo, address, and contact details</li>
                <li><strong>Add your courses/fees</strong> - Build your fee structure</li>
                <li><strong>Invite your staff</strong> - Add staff members to help manage your school</li>
                <li><strong>Start enrolling</strong> - Use the students section to record your first enrollment</li>
            </ul>

            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 25px 0; border-radius: 4px;">
                <p style="margin: 0;"><strong>💡 Tip:</strong> Explore the dashboard to see financial reports, manage courses, and track school performance in real-time.</p>
            </div>

            <p style="margin-top: 30px;">If you have any questions or need assistance, don't hesitate to reach out to our support team.</p>

            <p style="margin-top: 30px;">Best regards,<br><strong>The EduKE Team</strong></p>
        </div>
        <div class="footer">
            <p>Thank you for choosing EduKE for your school management needs</p>
        </div>
    </div>
</body>
</html>"""
...
<body>
    <div class="container">
        ...
        <p>We received a request to reset your password for your EduKE account.</p>
...
def generate_welcome_plain(
    ...
    return f"""Welcome to EduKE!

Hello {full_name},

Congratulations! Your school {business_name} has been successfully registered on EduKE.

YOUR SCHOOL DETAILS:
School Name: {business_name}
Subdomain: {subdomain}.eduke.com
Login URL: {login_url}

GETTING STARTED:
✓ Set up your school profile - Add your logo, address, and contact details
✓ Add your courses/fees - Build your fee structure
✓ Invite your staff - Add staff members to help manage your school
✓ Start enrolling - Use the students section to record your first enrollment

TIP: Explore the dashboard to see financial reports, manage courses, and track school performance in real-time.
...
---
Thank you for choosing EduKE for your school management needs
Powered by EduKE
"""
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p><strong>Thank you for choosing EduKE!</strong></p>
            <p>Powered by EduKE</p>
        </div>
    </div>
</body>
...
class EmailService:
    ...
    async def send_welcome_email(
        ...
        subject = f"Welcome to EduKE - {business_name} is ready!"

        print(f"Preparing welcome email for {user_email} - School: {business_name}")
