...
async def register_tenant(
    ...
    # Send welcome email to new school owner (fire and forget - non-blocking)
    if settings.POSTMARK_ENABLED:
        ...
        print(f"Queued welcome email to {tenant_data.owner_email} for school: {tenant_data.name}")
