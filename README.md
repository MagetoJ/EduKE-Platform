# EduKE School Management System

A comprehensive school management system for handling students, fee collection, and academic reporting. Built with FastAPI, PostgreSQL, React, and configured as a Progressive Web Application (PWA).

## Features

- 🔐 **User Authentication** - Secure JWT-based multi-tenant authentication
- 🎓 **Student Management** - Manage student profiles and enrollment
- 💳 **Fee Collection** - Process fee payments and generate receipts
- 📊 **Dashboard** - Visual analytics showing financial trends and enrollment stats
- 📄 **Receipt Printing** - Print-friendly fee receipt generation
